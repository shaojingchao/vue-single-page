<template>
  <div class="tablayout" id="tablayout-1">
    <div class="box-warp"
         v-bind:class="{'box-a4':layout.style==null || layout.style=='A4','box-a3':layout.style=='A3'}">
      <!--=====================切割标记=====================-->
      <ul class="black-box">
          ...
          <template v-for="(partItem,partItemIndex) in examPart">
            ...
            <template v-if="partItem.list.length>0">
              ...
              <div class="part-title center red hover">
                ...
                <p class="partname1">{{partItem.title}}&nbsp;
                  <small>{{partItem.desc}}</small>
                </p>
              </div>
              <!--分卷标题设置-END============-->
                    ...
                    <div class="q-choice clearfix">
                      ...
                      <div class="choice-item"
                        ...
                        <div v-for="(itemTr,itemTrIndex) in typeItem.content"
                             class="order-item"
                             v-if="(itemTrIndex+1)>(itemBlockIndex*5) && (itemTrIndex+1) <= ((itemBlockIndex+1)*5)"
                        ...
                        <div class="content-list">
                          <template v-for="(contentItem , subOrderID) in typeItem.content">
                            ...
                            <div class="com-grid clearfix">
                                                            <span
                                                              v-for="(charItem,charItemIndex) in Math.floor((contentItem.char-0)*(1.3))">
                                                                <em class="tips"
                        ...
                        <div class="content-list clearfix">
                          <template v-for="(contentItem , contentItemIndex) in typeItem.content">
                                                        <span class="number left"
                                                              v-bind:card-ques-id="contentItem.order">
                                                            {{contentItem.order}}.
                                                            <em class="score" v-if="score.display==1">({{contentItem.score}}分)</em>
                                                        </span>
